...
public class MCardTradeRevise {
    ...
    public String toString() {
        return QDATE+'\t' + LTIME +'\t'+ DT +'\t'+ XT + '\t'+ISSUEA+ '\t' + USEA + '\t'+ DSN + '\t'+ ICN + '\t'
                + FCN + '\t'+ LPID + '\t' + LTIM + '\t'+ PID +'\t' + TIM +'\t' + AmountUtil.convertToString(TF, 8) +'\t' +
                AmountUtil.convertToString(BAL, 8) + '\t' + AmountUtil.convertToString(FEE, 8) + '\t'
                + TT +'\t' + RN +'\t' + "0000" + '\t' + "000" + '\t' + "000" + '\t' + "000" + '\t' + EPID + '\t' + ETIM + '\t'
                + TAC + '\t' + BINF + '\t' + QNAME;
    }
}
